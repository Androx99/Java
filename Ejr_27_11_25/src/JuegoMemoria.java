...
public class JuegoMemoria {
    ...
    static final String[] palabras = {"sol", "luna", "estrella", "cielo", "mar", "montaña", "río", "nube", "flor", "árbol"};
    static  String[] respuestas = new String[10];

    static StringBuilder PalabrasAMemorizar (int i){
    ...
    public static void main(String[] args) {
        ...
        for (int i = 0; i < palabras.length; i++) {
            ...
            StringBuilder correctas=PalabrasAMemorizar(i);
